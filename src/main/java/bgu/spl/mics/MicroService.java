...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Event> , Callback<? extends Event>> eventCallbacks;
    private ConcurrentHashMap<Class<? extends Broadcast> , Callback<? extends Broadcast>> broadcastCallbacks;
    ...
    public MicroService(String name) {
        ...
        broadcastCallbacks = new ConcurrentHashMap<>();
        registered = false;
    }
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        return messageBus.sendEvent(e); //whoever called this sendEvent will set the returned future as its own future
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            Message a;
            try {
                a = messageBus.awaitMessage(this);
                if (a == null){
                   return;
                }
                else if (a instanceof Broadcast) {
                    Callback c = broadcastCallbacks.get(a.getClass());
                    c.call(a);
                }
                else{
                    Callback c = eventCallbacks.get(a.getClass());
                    c.call(a);
                }
    ...
    public ConcurrentHashMap<Class<? extends Event>, Callback<? extends Event>> getEventCallbacks() {
